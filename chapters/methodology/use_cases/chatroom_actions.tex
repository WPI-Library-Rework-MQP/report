...
\SubSubSection{General}{methodology}{use_cases}{chat_platform}{general}
    ...
    \UseCaseNew{User Archive Chatroom}{user_archive_chatroom}{%
        ...
        \FakeNumberedItem{2} The archive action is timestamped. \par
        \FakeNumberedItem{3} The display is updated for all actors. \par
        \FakeNumberedItem{4} A sound is played for all actors. \par
        \FakeNumberedItem{5} A notification is sent to all actors.
    }{%
    ...
    \UseCaseNew{Automatically Archive Chatroom}{automatically_archive_chatroom}{%
        ...
        \FakeNumberedItem{2} The archive action is timestamped. \par
        \FakeNumberedItem{3} The display is updated for all participating users. \par
        \FakeNumberedItem{4} A sound is played for all participating users. \par
        \FakeNumberedItem{5} A notification is sent to all participating users.
    }{%
